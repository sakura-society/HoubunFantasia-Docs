...
const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    link: "https://twitter.com/kaosu_sensei",
  },
];
...
function Project({ title, svg, link }: ProjectItem): JSX.Element {
  return (
    <div className={styles.project}>
      {svg}
      <a href={link} target="_blank" rel="noreferrer" title={title} className={styles.project__link}>
        {title}
